...
const DefaultLayout = ({ children }) => {
  ...
  //     // For example, you can navigate to a search results page or filter the displayed items
  //   } else {
  //     console.log("Invalid search query. Only letters and numbers are allowed.");
  //   }
  // };
  ...
  return (
    <Layout>
      ...
      <Sider trigger={null} collapsible collapsed={collapsed}>
        <div className="logo">
          <h1 className="text-center text-light font-weight-bold mb-4 mt-4">
            Jeevan 
            Plumbing
          </h1>
        </div>
        ...
        <div
          className="text-center text-light font-weight-bold mb-4 b-0 w-100 position-absolute"
