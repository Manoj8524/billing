                    ...
                    {selectedBill.cartItems.map((item) => (
                      <>
                        <tr className="service">
                          ...
                          </td><td className="tableitem">
                            <p className="itemtext">{selectedBill.paymentMode}</p>
                          </td>
                          <td className="tableitem">
